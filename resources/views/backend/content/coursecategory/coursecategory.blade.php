    ...
    <div class="row">
        <div class="col-sm-12 col-md-12 col-xl-12">
            <div class="h-100 bg-secondary rounded p-4 pb-0">
                <div class="d-flex align-items-center justify-content-between" style="width: 50%;float:left;">
                    <h6 class="mb-0">Coursecategory List</h6>
                </div>
                <div class="" style="width: 50%;float:left;">
                    <a type="button" data-bs-toggle="modal" data-bs-target="#mainCoursecategory" class="btn btn-primary m-2"
                        style="float: right"> + Create Coursecategory</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-12 col-md-12 col-xl-12">
            <div class="bg-secondary rounded h-100 p-4">
                <div class="data-tables">
                    <table class="table table-dark" id="coursecategoryinfo" width="100%" style="text-align: center;">
            ...
            <div class="modal-dialog">
                <div class="modal-content bg-secondary rounded h-100">
                    <div class="modal-header">
                        <h5 class="modal-title" style="color: red;">Create New Coursecategory</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <form name="form" id="AddCoursecategory" enctype="multipart/form-data">
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="coursecategory_name" id="coursecategory_name"
                                    placeholder="Coursecategory Name">
                                <label for="floatingInput">Coursecategory Name</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="youtube_embade" id="youtube_embade"
                                    placeholder="Youtube Code">
                                <label for="floatingInput">Youtube Code</label>
                            </div>
                            <div class="mt-4 mb-4">
                                <input class="form-control form-control-lg bg-dark" name="coursecategory_image"
                                    id="coursecategory_image" type="file">
                            </div>
                            <br>
        ...
        <div class="modal fade" id="editmainCoursecategory" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content bg-secondary rounded h-100">
                    <div class="modal-header">
                        <h5 class="modal-title" style="color: red;">Edit Coursecategory</h5>
                        <button type="button" class="btn-dark btn-close" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
...
<script>
    $(document).ready(function() {
                ...
                }, 
                {
                    ...
                    render: function(data) {
                        ...
                        if (data.status === 'Active') {
                            return '<button type="button" class="btn btn-success btn-sm btn-status" data-status="Inactive" id="coursecategorystatusBtn" data-id="' +
                                data.id + '">Active</button>';
                        } else {
                            return '<button type="button" class="btn btn-warning btn-sm btn-status" data-status="Active" id="coursecategorystatusBtn" data-id="' +
        ...
        $('#AddCoursecategory').submit(function(e) {
            ...
            $.ajax({ 
                type: 'POST',
                uploadUrl: '{{ route('coursecategories.store') }}',
                processData: false, 
                contentType: false,
        ...
        $(document).on('click', '#editCoursecategoryBtn', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    $('#EditCoursecategory').find('#coursecategory_name').val(data
                        .coursecategory_name);
                    $('#EditCoursecategory').find('#youtube_embade').val(data
                        .youtube_embade);
                    $('#EditCoursecategory').find('#coursecategory_id').val(data.id);

                    $('#previmg').html('');
                    $('#previmg').append(`
                        <img  src="../` + data.coursecategory_image + `" alt = "" style="height: 80px" />
                    `);
        ...
        $('#EditCoursecategory').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: 'coursecategory/' + coursecategoryId,
                processData: false,
                contentType: false,
                data: new FormData(this),
                ...
                success: function(data) {
                    ...
                    swal({
                        title: "Coursecategory update successfully !",
                        icon: "success",
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        $.ajax({
                            ...
                            success: function(data) {
                                swal("Coursecategory has been deleted!", {
                                    icon: "success",
                                });
