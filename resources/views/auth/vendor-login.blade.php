...
@section('maincontent')
@section('meta')
    <title>{{\App\Models\Basicinfo::first()->title}}-Vendor Login</title>
            ...
            <div class="row">
                ...
                <div class="mt-4 mb-4 col-md-6 col-sm-8 sign-in">
                    <div class="card" style="padding: 0px 18px;border-radius: 0px;">
                        <p class="pt-4 text-center"> <b>Hello Dear, Welcome to our Vendor Point.</b> </p>

                        <form class="register-form outer-top-xs" method="POST" action="{{ route('admin.login') }}"
                            ...
                            <button type="submit" id="lgbtnv"
                                class="btn-block btn-upper btn btn-dark checkout-page-button" >Login as Vendor</button>
                            <div class="text-right radio outer-xs" style="margin-top: 10px;margin-bottom:10px;">
                                <a href="{{ url('vendor-forgot-password') }}" class="forgot-password pull-right"
                                    style="color: #07b5fc">Forgot your Password?</a>
                            </div>
                        </form>

                        <h4 class="text-center" style="margin-bottom:20px;">
                            <a href="{{ url('vendor-register') }}" class="btn btn-info btn-sm text-light" id="lgbtnv">Become a Vendor</a>
                        </h4>
                        
                        <!-- Link to reseller login -->
                        <p class="text-center" style="margin-bottom:20px;">
                            Are you a Reseller? 
                            <a href="{{ url('login') }}" class="btn btn-sm" id="lgbtn">Login as Reseller</a>
                        </p>
                    </div>
                </div>
                <!-- Sign-in -->
