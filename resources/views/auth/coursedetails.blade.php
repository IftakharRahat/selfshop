                            ...
                            <div class="m-auto mb-2 col-12 col-lg-12">
                                <div class="card" style="border-radius:4px">
                                    <div class="p-2 card-body">
                                        @if($coursecategory->youtube_embade=='')
                                        <img src="{{asset($coursecategory->coursecategory_image)}}" style="width:100%;min-height: 185px;border-radius: 6px;">
                                        @else
                                        <iframe width="100%" height="200px" style="border:none;border-radius:6px;"
                                            src="https://www.youtube.com/embed/{{$coursecategory->youtube_embade}}">
                                        </iframe>
                                        @endif
                                    </div>
                                    <div class="p-2 card-footer d-flex justify-content-between">
                                        <div class="play">
                                            <p class="m-0" style="color: #000;font-family: Roboto;font-size: 14px;font-style: normal;font-weight: 600;">{{$coursecategory->coursecategory_name}}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
