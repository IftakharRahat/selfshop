...
@section('maincontent')
@section('title')
    {{ env('APP_NAME') }}-User Balance Transfer
@endsection
    ...
    <div class="row">
        <div class="p-2 pb-0 mb-4 col-sm-12 col-md-12 col-xl-12">
            <div class="p-4 rounded h-100"
                ...
                <h5 class="mt-2 text-center card-title" style="color:black">Balance Transfer</h5>

                <form name="form" id="NewTransfer" enctype="multipart/form-data" class="from-prevent-multiple-submits">
                    @csrf
                    <div class="row">
                        <div class="col-md-12 justify-content-center align-items-center">
                            ...
                            <div class="mt-3 form-group">
                                <label for="" class="mb-1"><b>How much money do you want to transfer?</b></label>
                                <div class="d-flex">
                                    <button style="padding: 0px 10px;border: 2px solid #efefef;font-weight: bold;border-radius: 4px;background: #efefef;">৳</button>
                                    <input type="text" style="border:1px solid #efefef;border-radius: 4px;margin-left: 10px;" class="form-control" name="withdrew_amount" id="withdrew_amount" placeholder="Enter Your Amount" required>
                                </div>
                            </div>

                            <div class="mt-3 form-group">
                                <label for="" class="mb-1"><b>To Send Money to Someone</b></label>
                                <div class="d-flex justify-content-between">
                                    <input type="text" style="border:1px solid #efefef;border-radius: 4px;" class="form-control" name="to_account_number" id="to_account_number" placeholder="Enter the account number" onchange="checkuser()" required>
                                </div>
                            </div>
                            <div class="mt-3 form-group">
                ...
                <div class="col-lg-12" style="overflow-x: auto;width: 100%;">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            @forelse ($transferlists->reverse() as $withdrew)
                                <tr>
                                    <td>
                                        #IN00{{$withdrew->id}}
                                    </td>
...
<script>
    ...
    function checkuser(){
        var email=$('#to_account_number').val();
        $.ajax({
            type: 'GET',
            url: '{{ url('check/user') }}',
            data:{
