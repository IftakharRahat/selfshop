            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-8 sign-in mb-4 mt-4">
                    <div class="card" style="padding: 0px 18px;border-radius: 6px;">
                        <h4 class="checkout-subtitle m-0 pb-2 pt-4 text-center"> <b>Fill Up The Form & Become a Vendor</b> </h4>
                        <form class="register-form outer-top-xs" method="POST" action="{{ url('vendor-register') }}" role="form">
                            @csrf
