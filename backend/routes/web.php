...
Route::get('checkout', [CartController::class, 'checkout'])->name('checkout');
        ...
        Route::group(['prefix' => 'user'], function () {
            ...
            Route::get('notifications', [WebviewController::class, 'notifications'])->name('user.notifications');
            Route::post('notifications/read-all', [WebviewController::class, 'markAllNotificationsRead'])->name('user.notifications.read-all');
            Route::post('notifications/{id}/read', [WebviewController::class, 'markNotificationRead'])->name('user.notifications.read');
