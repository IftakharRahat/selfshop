    ...
    <div class="container-fluid pt-4 px-4">
        ...
        <div class="admin-content-card">
            <div class="admin-card-header">
                <h6 class="admin-card-title"><i class="bi bi-box-seam me-2"></i>Account Package List</h6>
                <div class="admin-card-actions">
                    <button type="button" class="btn btn-sm" style="background: var(--admin-primary, #2d2a5d); color: #fff; border-radius: 6px;" data-bs-toggle="modal"
                        data-bs-target="#mainPackage"><i class="bi bi-plus-lg me-1"></i> Add New Package</button>
                </div>
            </div>
            <div class="admin-card-body p-0">
                ...
                <div class="table-responsive">
                    <table class="table admin-table mb-0" id="packageinfotbl" width="100%">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Package Name</th>
