...
@section('maincontent')
    ...
    $pagebanner =App\Models\Pagebanner::where('id',3)->where('status','Active')->first();
                ...
                @forelse ($terms as $term)
                    <div class="col-12 p-2">
                        <div class="xs-heading wow fadeIn animated" style="text-align:center;visibility: visible; animation-name: fadeIn;">
                            <h3 class="heading-title" style="float: left;"><span style="color:black;font-weight:bold">{{ $term->title }}</span></h3>
                        </div>
                    </div>
