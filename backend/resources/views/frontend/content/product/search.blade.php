...
<div class="container py-5">
    <div class="text-center mb-4 pb-4">
        <h2 class="section-title px-5"><span class="px-2" style="border-bottom:none">Search Reasult For: {{ Session::get('searchkeyword') }} </span></h2>
    </div>
            ...
            <div class="col-lg-2 col-6 p-2 pt-0 pb-2" >
                <div class="card product-item" style="border:1px solid;padding: 4px;">
                    <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0"
                        id="cardimg">
                        @if (empty($searchproduct->ProductImage))
                            <a href="{{ url('/product/' . $searchproduct->ProductSlug) }}"><img class="img-fluid w-100"
                                    src="{{ asset('public/frontend/') }}/img/product-1.jpg" alt=""></a>
                        @else
                            <a href="{{ url('/product/' . $searchproduct->ProductSlug) }}"><img class="img-fluid w-100"
                                    src="{{ asset($searchproduct->ProductImage) }}"
                                    alt="{{ $searchproduct->productName }}"></a>
                        @endif
                    </div>
                    <div class="card-body text-left p-0 pt-2">
                    ...
                    <div class="card-footer justify-content-between bg-light border" style="padding:0;">
                        ...
                        <a href="{{ url('/product/' . $searchproduct->ProductSlug) }}"
                            class="btn btn-info btn-sm btn-block text-dark"
                            style="border-radius: 6px;color: white !important;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">Order Now</a>
                        @endif
                    </div>
                </div>
            </div>
