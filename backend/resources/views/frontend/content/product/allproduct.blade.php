...
@section('maincontent')
    <div class="container py-2">
        <div class="mb-0" style="display: flex;justify-content: space-between;">
            <h2 class="titlelg" style=""><span class="" style="border-bottom: none !important;text-transform: uppercase;font-weight: bold;">Product Lists</span></h2>
        </div>
    ...
    <script>
        ...
        var ENDPOINTCAT = "{{ url('dataall-load-ajax') }}";
        var page = 1;
        var i=0;
