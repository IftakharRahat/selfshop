...
<div class="container-fluid pt-4 px-4">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" style="font-weight: 600;">Edit Product Request</h5>
    ...
    <div class="admin-content-card">
        <div class="admin-card-header">
            <h6 class="admin-card-title">Product Requests</h6>
        </div>
        <div class="admin-card-body">
            ...
            <div class="d-flex gap-2 flex-wrap mb-3">
                <a href="{{ url('admin/product-request/productrequestall') }}" class="btn btn-sm btn-outline-primary">Request All</a>
                <a href="{{ url('admin/product-request/Pending') }}" class="btn btn-sm btn-outline-warning">Pending</a>
                <a href="{{ url('admin/product-request/Accepted') }}" class="btn btn-sm btn-outline-info">Accepted</a>
                <a href="{{ url('admin/product-request/Done') }}" class="btn btn-sm btn-outline-success">Done</a>
                <a href="{{ url('admin/product-request/Cancel') }}" class="btn btn-sm btn-outline-danger">Cancel</a>
            </div>
...
<script>
    $(document).ready(function() {
        ...
        var productrqinfotbl = $('#productrqinfo').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: { url: "{{ url('admin/product-request/data/') }}" + '/' + statusproductrq },
            ...
            columns: [
                ...
                { "data": null, render: function(data) {
                    ...
                    else if (data.status === 'Done') return '<button type="button" class="btn btn-success btn-sm">Done</button>';
        ...
        $('#EditMenu').submit(function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#previmg').html('');
                    swal({ title: "Product request update successfully !", icon: "success", showCancelButton: true, focusConfirm: false, confirmButtonColor: "#DD6B55", confirmButtonText: "Yes", cancelButtonText: "No" });
