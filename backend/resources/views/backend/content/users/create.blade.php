    ...
    <form name="form" id="CreateRole" method="POST" action="{{ route("admin.users.store") }}" enctype="multipart/form-data">
        ...
        <div class="admin-content-card">
            <div class="admin-card-header">
                <h6 class="admin-card-title">Create New User</h6>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group mt-4">
                            <button type="submit" class="btn w-100" style="background: var(--admin-primary, #2d2a5d); color: #fff; border-radius: 8px; padding: 10px 16px; font-weight: 600;">Create User</button>
                        </div>
                    </div>
                </div>
            </div>
