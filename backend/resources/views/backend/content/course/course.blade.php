    ...
    <div class="row">
        <div class="col-sm-12 col-md-12 col-xl-12">
            <div class="h-100 bg-secondary rounded p-4 pb-0">
                <div class="d-flex align-items-center justify-content-between" style="width: 50%;float:left;">
                    <h6 class="mb-0">Course List</h6>
                </div>
                <div class="" style="width: 50%;float:left;">
                    <a type="button" data-bs-toggle="modal" data-bs-target="#mainCourse" class="btn btn-primary m-2"
                        style="float: right"> + Create Course</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-12 col-md-12 col-xl-12">
            <div class="bg-secondary rounded h-100 p-4">
                <div class="data-tables">
                    <table class="table table-dark" id="courseinfo" width="100%" style="text-align: center;">
            ...
            <div class="modal-dialog">
                <div class="modal-content bg-secondary rounded h-100">
                    <div class="modal-header">
                        <h5 class="modal-title" style="color: red;">Create New Course</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <form name="form" id="AddCourse" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3"> 
                                ...
                                <select name="coursecategory_id" class="form-control" id="coursecategory_id">
                            ...
                            <div class="mt-4 mb-4">
                                <input class="form-control form-control-lg bg-dark" name="course_image"
                                    id="course_image" type="file">
                            </div>
                            <br>
        ...
        <div class="modal fade" id="editmainCourse" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content bg-secondary rounded h-100">
                    <div class="modal-header">
                        <h5 class="modal-title" style="color: red;">Edit Course</h5>
                        <button type="button" class="btn-dark btn-close" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '#editCourseBtn', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    $('#EditCourse').find('#course_name').val(data
                        .course_name);
                    $('#EditCourse').find('#youtube_embade').val(data
                        .youtube_embade);
                    $('#EditCourse').find('#coursecategory_id').val(data
                        .coursecategory_id);
                    $('#EditCourse').find('#course_id').val(data.id);

                    $('#previmg').html('');
                    $('#previmg').append(`
                        <img  src="../` + data.course_image + `" alt = "" style="height: 80px" />
                    `);
