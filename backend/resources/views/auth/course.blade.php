        ...
        <div class="row">
            <div class="p-0 m-auto col-lg-12">
                <div class="p-2 pt-0">
                    <div class="container">
                        <div class="mb-3 row">
                            @forelse(App\Models\Coursecategory::where('status','Active')->get() as $course)
                                <div class="mb-3 col-12 col-lg-4">
                                    <a href="{{url('user/course-details',$course->slug)}}">
                                        <div class="card" style="    border: none;">
                                            <div class="p-0 card-body">
                                                @if($course->youtube_embade=='')
                                                <img src="{{asset($course->coursecategory_image)}}" style="width:100%;min-height: 185px;border-radius: 6px;">
                                                @else
                                            ...
                                            <div class="card-footer" style="background: none;border: none;    padding: 0;">
                                                <h5 class="mb-3">{{$course->coursecategory_name}}</h5>
                                                <div class=" d-flex justify-content-between">
                                                <div class="play d-flex justify-content-between">
                                                    <img src="{{asset('public/play.png')}}" style="height: 22px;">
                                                    <p class="pl-2 m-0">{{App\Models\Course::where('status','Active')->where('coursecategory_id',$course->id)->get()->count()}}  টি ভিডিও</p>
                                                </div>
                                                <div class="play">
                                                    <p class="m-0" style="color: #58B78C;font-family: Roboto;font-size: 16px;font-style: normal;font-weight: 600;"> ফ্রি দেখুন</p>
                                                </div>
                                                </div>
                                            </div>
                                        </div>
