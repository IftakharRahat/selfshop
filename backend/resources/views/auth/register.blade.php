...
@section('maincontent')
@section('meta')
    <title>{{\App\Models\Basicinfo::first()->title}}-Register</title>
                ...
                <div class="col-md-6 col-sm-8 sign-in mb-4 mt-4">
                    <div class="card" style="padding: 0px 18px;border-radius: 6px;">
                        ...
                        <form class="register-form outer-top-xs" method="POST" action="{{ url('register') }}" role="form">
                            ...
                            <div class="form-group">
                                <label class="info-title" for="exampleInputEmail2">Refer Code <span>(optional)</span></label>
                                <input type="text" name="refer_by" class="form-control unicase-form-control text-input" >
                            </div>
                            <div class="form-group">
