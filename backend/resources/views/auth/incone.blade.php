                        ...
                        <div class="row">
                            <div class="col-lg-12" style="overflow-x: auto;width: 100%;">
                                <div class="p-2 rounded ">
                                    <h4 class="mt-4 mb-0 mb-2 text-left" style="color:black;">Order income</h4>
                                </div>
                                    ...
                                    <tbody>
                                        @forelse ($messages->reverse() as $message)
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $order=App\Models\Order::where('invoiceID',$message->invoice_id)->first();
                                                    @endphp
                                                    @if(isset($order))
                                                        {{$order->subTotal}}
                                                    @else
                                                ...
                                                <td>
                                                    @if($message->status=='Pending')
                                                        <span class="status-badge status-claim">{{$message->status}}</span>
                                                    @elseif($message->status=='Canceled')
                                                        <span class="status-badge status-not">{{$message->status}}</span>
                                                    @else
                                                        <span class="status-badge status-accepted">{{$message->status}}</span>
                                                    @endif
                                                </td>
                                            </tr>
                                        @empty
