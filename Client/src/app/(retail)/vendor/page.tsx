  ...
  return (
    <div className="space-y-6">
      <div className="rounded-xl bg-white p-6 shadow-sm border border-gray-100">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Wholesale Dashboard</h1>
        <p className="text-gray-600">
          Use bulk ordering to buy mixed sizes/variants with automatic tier discounts. Tap a product and use <strong>Bulk Order</strong> for the matrix.
        </p>
      </div>
      <div className="rounded-xl bg-white p-6 shadow-sm border border-gray-100">
