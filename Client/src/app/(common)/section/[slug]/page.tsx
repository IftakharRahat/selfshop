...
const SectionPage = () => {
            ...
            try {
                ...
                if (result.status && result.data?.data) {
                    ...
                    if (result.section) {
                        ...
                        setBannerImage(result.section.banner_image || "");
                    }
    ...
    return (
        <section className="container mx-auto px-4 md:px-8 lg:px-16 py-10">
            {/* Banner */}
            {bannerImage && (
                <div className="relative w-full h-40 sm:h-56 lg:h-72 rounded-xl overflow-hidden mb-8">
                    <Image
                        src={bannerImage}
                        alt={sectionTitle}
                        fill
            ...
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6 capitalize">
                {sectionTitle || slug?.replace(/_/g, " ") || "Products"}
            </h1>
