        ...
        {contactMethods.map((method) => (
          <div
            ...
            className={`grid grid-cols-1 lg:grid-cols-2 gap-8 items-center ${
              method.layout === "image-right" ? "lg:[&>*:first-child]:order-2" : ""
            }`}
          >
            {/* Image */}
            ...
            <div>
              ...
              <p className="text-gray-600 text-base leading-relaxed mb-6">{method.description}</p>
              <Link href={"/contact"} className="bg-[#E7005E] hover:bg-pink-600 text-white font-medium px-6 py-3 rounded-lg transition-colors duration-200">
