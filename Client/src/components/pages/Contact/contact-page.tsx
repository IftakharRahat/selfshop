          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="p-6 lg:p-12">
              ...
              <p className="text-gray-600 mb-8 leading-relaxed">
                Lorem ipsum dolor sit amet consectetur. Dignissim erat odio dictum curabitur donec at consequat arcu
                cursus. Eget quis cum amet iaculis orci non.
              </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <p className="text-gray-900 font-medium">contact@selfshop.com.bd</p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-8">
                Have questions, suggestions, or need assistance? We&apos;d love to hear from you! Whether you&apos;re looking to
                collaborate, inquire about our GPS products, or learn more about our sustainability initiatives, our
