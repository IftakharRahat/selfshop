      ...
      >
        ...
        {activeTab === "reseller" ? (
          <>
            {isLogin ? (
              ...
              <Form form={form} layout="vertical" onFinish={handleRegistration} initialValues={{ remember: true }}>
                <Form.Item name="name" label="Name" rules={[{ required: true, message: "Please input your name!" }]}>
                  <Input size="large" placeholder="Enter your name..." />
                </Form.Item>
                <Form.Item name="email" label="Phone" rules={[{ required: true, message: "Please input your phone number!" }]}>
                  <Input size="large" placeholder="Enter your phone number..." />
                </Form.Item>
        ...
        {isLogin ? (
          <p className="text-center mt-5">
            ...
            <span onClick={() => setIsLogin(false)} className="text-[#E5005F] cursor-pointer">
              register now
            </span>
          </p>
        ) : (
          <p className="text-center mt-5">
            ...
            <span onClick={() => setIsLogin(true)} className="text-[#E5005F] cursor-pointer">
              log in
            </span>
          </p>
        )}
