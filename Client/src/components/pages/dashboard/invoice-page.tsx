      ...
      <div className="p-8 text-center space-y-6">
        ...
        <div className="space-y-4">
          <p className="text-gray-700 text-sm leading-relaxed">
            Thank you for selecting your preferred package. We have created an Invoice ID for you. Copy the invoice ID
            by clicking the copy button below and go to the PAY NOW option and put your Invoice ID in the reference and
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-center space-x-3 p-4 bg-gray-50 rounded-lg">
            <span className="text-pink-600 font-bold text-lg">INVOICE ID: {invoiceId}</span>
            <button
              onClick={handleCopy}
          ...
          <p className="text-gray-600 text-sm">
            Thanks for your order. Please copy the Invoice ID and paste it to payment reference box.
          </p>
        </div>
