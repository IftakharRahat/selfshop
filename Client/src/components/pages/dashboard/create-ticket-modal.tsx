  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button className="bg-[#E91E63] hover:bg-[#C2185B] text-white">+ Add now</Button>
      </DialogTrigger>
      <DialogContent className="sm:max-w-[600px] p-0 gap-0 bg-white">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="px-6 pb-6 space-y-4">
                ...
                render={({ field }) => (
                  <Select value={field.value} onValueChange={field.onChange} >
                    ...
                    <SelectContent className="bg-white">
                      ...
                      <SelectItem value="Parcel Support">Parcel Support</SelectItem>
          ...
          <div className="flex gap-3 pt-2">
            ...
            <Button type="submit" className="flex-1 bg-[#4CAF50] hover:bg-[#45a049] text-white">
              Save
            </Button>
          </div>
        </form>
