    ...
    <div className="bg-[#FDF0F6] py-12 lg:py-20">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-3xl mx-auto text-base lg:text-lg leading-relaxed">
            We specialize in curating a broad selection of trending and high-demand products tailored to entrepreneurs
            and online resellers. Our product range includes:
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          {offerItems.map((item, index) => (
            ...
            >
              ...
              <h3 className="font-semibold text-gray-900 mb-2 text-sm lg:text-base leading-tight">{item.title}</h3>
            </div>
          ))}
        </div>
      </div>
            ...
            <div className="space-y-4">
              {accordionItems.map((item, index) => (
                <div key={index} className="bg-white rounded-lg border border-gray-200 overflow-hidden">
                  ...
                  >
                    <span className="font-semibold text-gray-900 text-base lg:text-lg">{item.title}</span>
                    {openAccordion === index ? (
...
const defaultAccordionItems = [
  {
    ...
    content: "We partner with reputable suppliers to guarantee top-tier products.",
  },
  {
