    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-8">
      <div className="max-w-2xl w-full bg-white rounded-lg shadow-sm p-8 md:p-12 text-center">
        ...
        <p className="text-gray-600 mb-6 leading-relaxed">
          Your order has been received and we are working to process it as soon as possible. Our team will update you on
          your order shortly.
        </p>

        {/* Support Message */}
        <p className="text-gray-600 mb-6 leading-relaxed">
          We appreciate your trust and support. If you have any questions or need assistance, please contact our
          customer support.
        </p>

        {/* Closing Message */}
        <p className="text-gray-700 font-medium mb-6">Thanks for staying with SelfShop!</p>

        {/* Contact Information */}
        <p className="text-gray-600 mb-8">
          For any needs, call: <span className="text-pink-600 font-medium">{customerPhone}</span>
        </p>
