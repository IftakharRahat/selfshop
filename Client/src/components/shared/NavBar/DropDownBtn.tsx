			...
			switch (event.key) {
				...
				case "ArrowDown":
					...
					setFocusedIndex((prev) =>
						prev < menuData.length - 1 ? prev + 1 : 0,
					);
					break;
				case "ArrowUp":
					event.preventDefault();
					setFocusedIndex((prev) =>
						prev > 0 ? prev - 1 : menuData.length - 1,
					);
					break;
				case "Enter":
				case " ":
			...
			<div className="absolute left-full top-0 min-w-[200px] z-20">
				<div className="mx-2 bg-white border border-gray-200 rounded-lg shadow-lg">
                    ...
                    ${
								...
								{activeSubMenuIndex === subIndex &&
									renderSubSubMenu(sub.sub_sub_items)}
							</li>
						))}
					</ul>
				</div>
			...
			>
				<div className="bg-white border border-gray-200 rounded-lg shadow-lg">
                    ...
                    ${
								...
								{activeMenuIndex === menuIndex &&
									renderSubMenu(menu.sub_items, menuIndex)}
							</li>
						))}
					</ul>
				</div>
